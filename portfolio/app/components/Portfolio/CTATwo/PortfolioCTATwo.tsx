...
interface PortfolioCTATwoProps {
    data: ACFCTA2 | null;
}

const PortfolioCTATwo = ({ data }: PortfolioCTATwoProps) => {
    if (!data) return null;
    ...
    return (
        <section id="portfolio-cta-2" className="cta-2 section-spacing">
                                        ...
                                        {(() => {
                                            ...
                                            return (
                                                <div className="sub-heading-image">
                                                    <Image src={icon} alt="CTA Icon" width={20} height={20} className="img-fluid" />
                                                </div>
                                            );
                                        })()}
...
export default PortfolioCTATwo;
